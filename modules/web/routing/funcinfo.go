...
// shortenFilename generates a short source code filename from a full package path, eg: "github.com/skygenesisenterprise/giteria/routers/common/logger_context.go" => "common/logger_context.go"
