...
import (
	...
	"github.com/skygenesisenterprise/giteria/server/api/packages/alpine"
	"github.com/skygenesisenterprise/giteria/server/api/packages/arch"
	"github.com/skygenesisenterprise/giteria/server/api/packages/cargo"
	"github.com/skygenesisenterprise/giteria/server/api/packages/chef"
	"github.com/skygenesisenterprise/giteria/server/api/packages/composer"
	"github.com/skygenesisenterprise/giteria/server/api/packages/conan"
	"github.com/skygenesisenterprise/giteria/server/api/packages/conda"
	"github.com/skygenesisenterprise/giteria/server/api/packages/container"
	"github.com/skygenesisenterprise/giteria/server/api/packages/cran"
	"github.com/skygenesisenterprise/giteria/server/api/packages/debian"
	"github.com/skygenesisenterprise/giteria/server/api/packages/generic"
	"github.com/skygenesisenterprise/giteria/server/api/packages/goproxy"
	"github.com/skygenesisenterprise/giteria/server/api/packages/helm"
	"github.com/skygenesisenterprise/giteria/server/api/packages/maven"
	"github.com/skygenesisenterprise/giteria/server/api/packages/npm"
	"github.com/skygenesisenterprise/giteria/server/api/packages/nuget"
	"github.com/skygenesisenterprise/giteria/server/api/packages/pub"
	"github.com/skygenesisenterprise/giteria/server/api/packages/pypi"
	"github.com/skygenesisenterprise/giteria/server/api/packages/rpm"
	"github.com/skygenesisenterprise/giteria/server/api/packages/rubygems"
	"github.com/skygenesisenterprise/giteria/server/api/packages/swift"
	"github.com/skygenesisenterprise/giteria/server/api/packages/vagrant"
