...
import (
	...
	"github.com/skygenesisenterprise/giteria/server/src/config"
	"github.com/skygenesisenterprise/giteria/server/src/interfaces"
	"github.com/skygenesisenterprise/giteria/server/src/routes"
...
func displayBanner() {
	...
	fmt.Printf("\033[1;33m    ║                      GITERIA SERVER                          ║\n")
	fmt.Printf("\033[1;33m    ║              Enterprise Git Repository Management            ║\n")
...
func main() {
	...
	fmt.Printf("\033[1;34m[info] Initializing giteria system...\033[0m\n")
	...
	router.Use(sessions.Sessions("giteria_oauth_session", store))
	time.Sleep(200 * time.Millisecond)
	...
	fmt.Printf("\n")
	fmt.Printf("\033[1;36m┌─────────────────────────────────────────────────────────────────┐\n")
	fmt.Printf("\033[1;36m│                      🚀 GITERIA SERVER READY                    │\n")
	fmt.Printf("\033[1;36m├─────────────────────────────────────────────────────────────────┤\n")
