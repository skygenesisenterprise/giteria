...
import (
	...
	actions_router "github.com/skygenesisenterprise/giteria/server/src/controllers/api/actions"
	packages_router "github.com/skygenesisenterprise/giteria/server/src/controllers/api/packages"
	apiv1 "github.com/skygenesisenterprise/giteria/server/src/controllers/api/v1"
	"github.com/skygenesisenterprise/giteria/server/src/controllers/private"
...
func NormalRoutes() *web.Router {
	...
	if setting.Actions.Enabled {
		...
		// TODO: Pipeline api used for runner internal communication with giteria server. but only artifact is used for now.
