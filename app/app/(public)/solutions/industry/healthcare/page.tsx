...
const challenges = [
  {
    ...
    description:
      "Navigate complex compliance frameworks with comprehensive audit trails and documentation requirements.",
  },
  {
    icon: Lock,
    title: "Sensitive Patient Data",
    description:
      "Protect electronic health records and personally identifiable information with robust security controls.",
  },
  {
    icon: Shield,
    title: "Security & Privacy Risks",
    description:
      "Mitigate vulnerabilities in medical software and prevent data breaches that could compromise patient safety.",
  },
  {
    icon: ClipboardList,
    title: "Audit and Compliance Demands",
    description:
      "Meet rigorous auditing requirements with detailed activity logs and change tracking.",
  },
  {
    icon: Server,
    title: "Legacy Systems Modernization",
    description:
      "Transition from outdated infrastructure while maintaining reliability and compliance standards.",
  },
];
...
const securityFeatures = [
  ...
  },
  {
    ...
    description:
      "Streamline deployments with automated pipelines that include security scanning, testing, and compliance checks.",
  },
  {
    icon: Eye,
...
const workflowSteps = [
  ...
  {
    step: "03",
    title: "Compliance-Aware Review",
    description:
      "Security teams and compliance officers review changes with audit trails. Approvals are tracked with full accountability.",
  },
  {
    step: "04",
    title: "Controlled Deployment",
    description:
      "Deploy to staging and production environments with approval workflows. Environment-specific configurations keep production secrets secure.",
  },
  {
    step: "05",
    title: "Continuous Monitoring",
    description:
      "Ongoing surveillance detects anomalies, tracks security metrics, and alerts teams to potential issues in real-time.",
  },
];
...
const benefits = [
  {
    ...
    description:
      "Minimize regulatory exposure with built-in security controls, audit trails, and compliance documentation.",
  },
  {
    icon: Lock,
    title: "Enhanced Security Posture",
    description:
      "Protect intellectual property and patient data with enterprise-grade security features.",
  },
  {
    icon: Users,
    title: "Improved Collaboration",
    description:
      "Bridge the gap between development teams and regulatory compliance with transparent workflows.",
  },
  {
    icon: Rocket,
  ...
  },
  {
    ...
    description:
      "Grow your development operations from small teams to enterprise scale with consistent security.",
  },
];
...
export default function HealthcarePage() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="text-left max-w-2xl">
              ...
              <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-5 tracking-tight leading-tight">
                Secure development
                <span className="block text-primary">for healthcare</span>
                <span className="block text-foreground">and life sciences.</span>
              </h1>

              <p className="text-base text-muted-foreground mb-6 leading-relaxed">
                Build, deploy, and manage healthcare applications with confidence. Giteria provides
                the security, traceability, and compliance features that regulated environments
                demand.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                <Link href="/contact">
                  ...
                  >
                    Secure Your Healthcare Development
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-muted/50 border-b border-border">
                  ...
                  <div className="flex-1 text-center">
                    <span className="text-xs text-muted-foreground font-mono">
                      Healthcare Application - Secure Branch
                    </span>
                  </div>
                </div>
                <div className="p-4">
                  ...
                  <div className="space-y-2 text-muted-foreground">
                    <div className="flex gap-2">
                      <span className="text-green-500">+342</span>
                      <span className="text-destructive">-28</span>
                      <span className="text-foreground">
                        feat: add patient data encryption module
                      </span>
                    </div>
          ...
          <div className="mt-12 pt-8 border-t border-border">
            <p className="text-center text-sm text-muted-foreground mb-6">
              Trusted by healthcare technology teams worldwide
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Healthcare development <span className="text-primary">challenges</span>
            </h2>
            <p className="text-muted-foreground max-w-xl mx-auto">
              Building software for healthcare requires navigating unique challenges that span
      ...
      {/* Secure & Compliant Development Section */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                Giteria provides the foundation for building secure healthcare applications. Every
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Example workflow for <span className="text-primary">healthcare teams</span>
            </h2>
            <p className="text-muted-foreground max-w-xl mx-auto">
          ...
          <div className="mt-12 relative">
            ...
            <div className="relative bg-card border border-border rounded-xl overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-2 bg-muted/50 border-b border-border">
                ...
                <span className="text-xs text-muted-foreground font-mono">
                  .giteria/workflows/healthcare-secure.yml
                </span>
              </div>
              <div className="p-4 font-mono text-xs md:text-sm">
                <div>
                  <span className="text-primary">name</span>: Healthcare Secure Pipeline
                </div>
                <div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Benefits for <span className="text-primary">healthcare organizations</span>
            </h2>
            <p className="text-muted-foreground max-w-xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Giteria is a secure, reliable, and scalable development platform designed for
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      sensitive healthcare data resides.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
            Build Secure Healthcare Solutions with Giteria
          </h2>
