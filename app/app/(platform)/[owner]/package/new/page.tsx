...
interface OrgPackagesNewPageProps {
...
export default function OrgPackagesNewPage({ params }: OrgPackagesNewPageProps) {
        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="sm" asChild>
              <Link href={`/${resolvedParams.owner}/packages`} className="flex items-center gap-1">
